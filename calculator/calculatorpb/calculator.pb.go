...
var file_calculator_calculatorpb_calculator_proto_rawDesc = []byte{
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x4d, 0x61, 0x78, 0x69, 0x6d, 0x75,
	0x6d, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x07, 0x4d, 0x61, 0x78, 0x69, 0x6d, 0x75, 0x6d,
	0x22, 0x2b, 0x0a, 0x11, 0x53, 0x71, 0x75, 0x61, 0x72, 0x65, 0x72, 0x6f, 0x6f, 0x74, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x06, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x22, 0x35, 0x0a,
	0x12, 0x53, 0x71, 0x75, 0x61, 0x72, 0x65, 0x72, 0x6f, 0x6f, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f,
	...
	0x52, 0x6f, 0x6f, 0x74, 0x32, 0xc9, 0x03, 0x0a, 0x11, 0x43, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61,
	...
	0x73, 0x65, 0x22, 0x00, 0x12, 0x78, 0x0a, 0x17, 0x50, 0x72, 0x69, 0x6d, 0x65, 0x4e, 0x75, 0x6d,
	0x62, 0x65, 0x72, 0x44, 0x65, 0x63, 0x6f, 0x6d, 0x70, 0x6f, 0x73, 0x74, 0x69, 0x6f, 0x6e, 0x12,
	...
	0x0a, 0x0d, 0x43, 0x6f, 0x6d, 0x70, 0x75, 0x74, 0x65, 0x41, 0x76, 0x65, 0x72, 0x67, 0x65, 0x12,
	...
	0x43, 0x6f, 0x6d, 0x70, 0x75, 0x74, 0x65, 0x41, 0x76, 0x65, 0x72, 0x61, 0x67, 0x65, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x28, 0x01, 0x12, 0x55, 0x0a, 0x0c, 0x46, 0x69,
	0x6e, 0x64, 0x4d, 0x61, 0x78, 0x6d, 0x69, 0x6e, 0x75, 0x6d, 0x12, 0x1e, 0x2e, 0x63, 0x61, 0x6c,
	...
	0x61, 0x72, 0x65, 0x72, 0x6f, 0x6f, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1e,
	0x2e, 0x63, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x6f, 0x72, 0x2e, 0x53, 0x71, 0x75, 0x61,
	0x72, 0x65, 0x72, 0x6f, 0x6f, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00,
	0x42, 0x0c, 0x5a, 0x0a, 0x63, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x6f, 0x72, 0x62, 0x06,
...
var file_calculator_calculatorpb_calculator_proto_depIdxs = []int32{
	...
	2, // 1: calculator.CalculatorService.PrimeNumberDecompostion:input_type -> calculator.PrimeNumberDecompositionRequest
	4, // 2: calculator.CalculatorService.ComputeAverge:input_type -> calculator.ComputeAverageRequest
	6, // 3: calculator.CalculatorService.FindMaxminum:input_type -> calculator.FindMaximumRequest
	...
	3, // 6: calculator.CalculatorService.PrimeNumberDecompostion:output_type -> calculator.PrimeNumberDecompositionResponse
	5, // 7: calculator.CalculatorService.ComputeAverge:output_type -> calculator.ComputeAverageResponse
	7, // 8: calculator.CalculatorService.FindMaxminum:output_type -> calculator.FindMaximumResponse
...
type CalculatorServiceClient interface {
	...
	PrimeNumberDecompostion(ctx context.Context, in *PrimeNumberDecompositionRequest, opts ...grpc.CallOption) (CalculatorService_PrimeNumberDecompostionClient, error)
	ComputeAverge(ctx context.Context, opts ...grpc.CallOption) (CalculatorService_ComputeAvergeClient, error)
	FindMaxminum(ctx context.Context, opts ...grpc.CallOption) (CalculatorService_FindMaxminumClient, error)
	//Error handling
...
func (c *calculatorServiceClient) PrimeNumberDecompostion(ctx context.Context, in *PrimeNumberDecompositionRequest, opts ...grpc.CallOption) (CalculatorService_PrimeNumberDecompostionClient, error) {
	stream, err := c.cc.NewStream(ctx, &_CalculatorService_serviceDesc.Streams[0], "/calculator.CalculatorService/PrimeNumberDecompostion", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *calculatorServicePrimeNumberDecompostionClient) Recv() (*PrimeNumberDecompositionResponse, error) {
...
func (c *calculatorServiceClient) ComputeAverge(ctx context.Context, opts ...grpc.CallOption) (CalculatorService_ComputeAvergeClient, error) {
	stream, err := c.cc.NewStream(ctx, &_CalculatorService_serviceDesc.Streams[1], "/calculator.CalculatorService/ComputeAverge", opts...)
	if err != nil {
		return nil, err
	}
	x := &calculatorServiceComputeAvergeClient{stream}
	return x, nil
}

type CalculatorService_ComputeAvergeClient interface {
	Send(*ComputeAverageRequest) error
	CloseAndRecv() (*ComputeAverageResponse, error)
	grpc.ClientStream
}

type calculatorServiceComputeAvergeClient struct {
	grpc.ClientStream
}

func (x *calculatorServiceComputeAvergeClient) Send(m *ComputeAverageRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *calculatorServiceComputeAvergeClient) CloseAndRecv() (*ComputeAverageResponse, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
...
func (c *calculatorServiceClient) FindMaxminum(ctx context.Context, opts ...grpc.CallOption) (CalculatorService_FindMaxminumClient, error) {
	stream, err := c.cc.NewStream(ctx, &_CalculatorService_serviceDesc.Streams[2], "/calculator.CalculatorService/FindMaxminum", opts...)
	if err != nil {
		return nil, err
	}
	x := &calculatorServiceFindMaxminumClient{stream}
	return x, nil
}

type CalculatorService_FindMaxminumClient interface {
	Send(*FindMaximumRequest) error
	Recv() (*FindMaximumResponse, error)
	grpc.ClientStream
}

type calculatorServiceFindMaxminumClient struct {
	grpc.ClientStream
}

func (x *calculatorServiceFindMaxminumClient) Send(m *FindMaximumRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *calculatorServiceFindMaxminumClient) Recv() (*FindMaximumResponse, error) {
...
type CalculatorServiceServer interface {
	...
	PrimeNumberDecompostion(*PrimeNumberDecompositionRequest, CalculatorService_PrimeNumberDecompostionServer) error
	ComputeAverge(CalculatorService_ComputeAvergeServer) error
	FindMaxminum(CalculatorService_FindMaxminumServer) error
	//Error handling
	//this rpc will throw error if number in negative : an invalid argument
...
func (*UnimplementedCalculatorServiceServer) PrimeNumberDecompostion(*PrimeNumberDecompositionRequest, CalculatorService_PrimeNumberDecompostionServer) error {
	return status.Errorf(codes.Unimplemented, "method PrimeNumberDecompostion not implemented")
}
func (*UnimplementedCalculatorServiceServer) ComputeAverge(CalculatorService_ComputeAvergeServer) error {
	return status.Errorf(codes.Unimplemented, "method ComputeAverge not implemented")
}
func (*UnimplementedCalculatorServiceServer) FindMaxminum(CalculatorService_FindMaxminumServer) error {
	return status.Errorf(codes.Unimplemented, "method FindMaxminum not implemented")
}
...
func (x *calculatorServicePrimeNumberDecompostionServer) Send(m *PrimeNumberDecompositionResponse) error {
	return x.ServerStream.SendMsg(m)
}

func _CalculatorService_ComputeAverge_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(CalculatorServiceServer).ComputeAverge(&calculatorServiceComputeAvergeServer{stream})
}

type CalculatorService_ComputeAvergeServer interface {
	SendAndClose(*ComputeAverageResponse) error
	Recv() (*ComputeAverageRequest, error)
	grpc.ServerStream
}

type calculatorServiceComputeAvergeServer struct {
	grpc.ServerStream
}

func (x *calculatorServiceComputeAvergeServer) SendAndClose(m *ComputeAverageResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *calculatorServiceComputeAvergeServer) Recv() (*ComputeAverageRequest, error) {
...
func _CalculatorService_FindMaxminum_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(CalculatorServiceServer).FindMaxminum(&calculatorServiceFindMaxminumServer{stream})
}

type CalculatorService_FindMaxminumServer interface {
	Send(*FindMaximumResponse) error
	Recv() (*FindMaximumRequest, error)
	grpc.ServerStream
}

type calculatorServiceFindMaxminumServer struct {
	grpc.ServerStream
}

func (x *calculatorServiceFindMaxminumServer) Send(m *FindMaximumResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *calculatorServiceFindMaxminumServer) Recv() (*FindMaximumRequest, error) {
...
var _CalculatorService_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "ComputeAverge",
			Handler:       _CalculatorService_ComputeAverge_Handler,
			ClientStreams: true,
		},
		{
			StreamName:    "FindMaxminum",
			Handler:       _CalculatorService_FindMaxminum_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
